...
var ini$1 = getDefaultExportFromCjs(ini);
var coreInfoMap = {
...
var browserfs = getDefaultExportFromCjs(browserfsExports);
var browserfs$1 = _mergeNamespaces({
  __proto__: null,
  default: browserfs
}, [browserfsExports]);
var raUserdataDir$1 = "/home/web_user/retroarch/userdata";
...
var { Buffer } = browserfsExports.BFSRequire("buffer");
var path = browserfsExports.BFSRequire("path");
var { basename, extname, dirname, join, relative } = path;
...
var raUserdataDir = "/home/web_user/retroarch/userdata";
var raBundleDir = "/home/web_user/retroarch/bundle";
var raContentDir = join(raUserdataDir, "content");
var raSystemDir = join(raUserdataDir, "system");
var raConfigDir = join(raUserdataDir, "config");
var raShaderDir = join(raBundleDir, "shaders", "shaders_glsl");
var raConfigPath = join(raUserdataDir, "retroarch.cfg");
var raCoreConfigPath = join(raUserdataDir, "retroarch-core-options.cfg");
var Emulator = class {
  constructor(options) {
...
var _Nostalgist = class _Nostalgist2 {
  constructor(options) {
    __publicField(this, "options");
    __publicField(this, "emulatorOptions");
    __publicField(this, "emulator");
    const globalOptions = { ..._Nostalgist2.globalOptions };
  ...
  static resetToDefault() {
    _Nostalgist2.configure(getDefaultOptions());
  }
  /**
  ...
  static configure(options) {
    merge(_Nostalgist2.globalOptions, options);
  }
  /**
  ...
  static async launch(options) {
    const nostalgist = new _Nostalgist2(options);
    await nostalgist.launch();
    return nostalgist;
  }
  static async gb(options) {
    return await _Nostalgist2.launchSystem("gb", options);
  }
  static async gba(options) {
    return await _Nostalgist2.launchSystem("gba", options);
  }
  static async gbc(options) {
    return await _Nostalgist2.launchSystem("gbc", options);
  }
  static async megadrive(options) {
    return await _Nostalgist2.launchSystem("megadrive", options);
  }
  static async nes(options) {
    return await _Nostalgist2.launchSystem("nes", options);
  }
  static async snes(options) {
    return await _Nostalgist2.launchSystem("snes", options);
  }
  ...
  static async launchSystem(system, options) {
    ...
    const core = _Nostalgist2.getCoreForSystem(system);
    return await _Nostalgist2.launch({ ...launchOptions, core });
  }
  getEmulator() {
    const { emulator } = this;
    if (!emulator) {
  ...
  getRetroarchOption() {
    const options = {};
    merge(options, _Nostalgist2.globalOptions.retroarchConfig, this.options.retroarchConfig);
    return options;
  }
  getRetroarchCoreOption() {
    const options = {};
    merge(options, _Nostalgist2.globalOptions.retroarchCoreConfig, this.options.retroarchCoreConfig);
    return options;
  }
  loadEmulator() {
